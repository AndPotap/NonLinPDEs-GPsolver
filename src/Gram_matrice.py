...
def Gram_matrix_assembly(X_domain, X_boundary, eqn="Nonlinear_elliptic", kernel="Gaussian", kernel_parameter=0.2):
    ...
    if eqn == "Nonlinear_elliptic":
        ...
        val = vmap(lambda x1, x2, y1, y2: K.Delta_x_Delta_y_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), onp.transpose(XXdd0).flatten(), onp.transpose(XXdd1).flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdbdb0.flatten(), XXdbdb1.flatten(), onp.transpose(XXdbdb0).flatten(), onp.transpose(XXdbdb1).flatten()
        )
        Theta[N_domain:, N_domain:] = onp.reshape(val, (N_domain + N_boundary, N_domain + N_boundary))

        # interior v.s. interior+boundary
        val = vmap(lambda x1, x2, y1, y2: K.Delta_x_kappa(x1, x2, y1, y2, kernel_parameter))(
        ...
        val = vmap(lambda x1, x2, y1, y2: K.D_x1_D_y1_kappa(x1, x2, y1, y2, kernel_parameter))(
        ...
        val = vmap(lambda x1, x2, y1, y2: K.D_x1_D_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.D_x1_DD_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.D_x2_D_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        Theta = Theta.at[N_domain : 2 * N_domain, N_domain : 2 * N_domain].set(jnp.reshape(val, (N_domain, N_domain)))

        val = vmap(lambda x1, x2, y1, y2: K.D_x2_DD_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.DD_x2_DD_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        ...
        # interior v.s. interior+boundary
        val = vmap(lambda x1, x2, y1, y2: K.D_x1_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXddb0.flatten(), XXddb1.flatten(), XXddb0_2.flatten(), XXddb1_2.flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.D_x2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXddb0.flatten(), XXddb1.flatten(), XXddb0_2.flatten(), XXddb1_2.flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.DD_x2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXddb0.flatten(), XXddb1.flatten(), XXddb0_2.flatten(), XXddb1_2.flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.Delta_x_D_y1_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.Delta_x_D_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), jnp.transpose(XXdd0).flatten(), jnp.transpose(XXdd1).flatten()
        )
        ...
        val = vmap(lambda x1, x2, y1, y2: K.D_x2_D_y1_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXdd0.flatten(), XXdd1.flatten(), onp.transpose(XXdd0).flatten(), onp.transpose(XXdd1).flatten()
        )
...
def construct_Theta_test(
    X_test, X_domain, X_boundary, eqn="Nonlinear_elliptic", kernel="Gaussian", kernel_parameter=0.2
):
    ...
    if eqn == "Nonlinear_elliptic":
        ...
        val = vmap(lambda x1, x2, y1, y2: K.Delta_y_kappa(x1, x2, y1, y2, kernel_parameter))(
        ...
        # constructing Theta matrix
        val = vmap(lambda x1, x2, y1, y2: K.D_y1_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXtd0.flatten(), XXtd1.flatten(), XXtd0_2.flatten(), XXtd1_2.flatten()
        )
        Theta_test[:, :N_domain] = onp.reshape(val, (N_test, N_domain))

        val = vmap(lambda x1, x2, y1, y2: K.D_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXtd0.flatten(), XXtd1.flatten(), XXtd0_2.flatten(), XXtd1_2.flatten()
        )
        Theta_test[:, N_domain : 2 * N_domain] = onp.reshape(val, (N_test, N_domain))

        val = vmap(lambda x1, x2, y1, y2: K.DD_y2_kappa(x1, x2, y1, y2, kernel_parameter))(
            XXtd0.flatten(), XXtd1.flatten(), XXtd0_2.flatten(), XXtd1_2.flatten()
        )
